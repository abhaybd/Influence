...
export default function Rules(props) {
    return (
        <div id="rules-box">
            ...
            challenge it.
            <br/><br/>
            <b>Challenge:</b> When a player declares an action they are declaring to the rest of the players that they have
            ...
            <hl id = "captain-color">STEAL</hl>: Steal 2 coins from a target. Blockable by <hl id = "captain-color">Captain</hl> or <hl id = "ambassador-color">Ambassador</hl>. Can block <hl id = "captain-color">STEAL</hl><br/><br/>

            <u id = "assassin-color">Assassin</u><br/>
            <hl id = "assassin-color">ASSASSINATE</hl>: Pay 3 coins to choose a target to assassinate (target loses an influence). <hl id = "contessa-color">Blockable by
            Contessa.</hl><br/><br/>

            <u id = "duke-color">Duke</u><br/>
            <hl id = "duke-color">TAX</hl>: Collect 3 coins from the treasury. Not blockable. Can block Foreign Aid.<br/><br/>

            <u id = "ambassador-color">Ambassador</u><br/>
            <hl id = "ambassador-color">EXCHANGE</hl>: Draw 2 influences into your hand and pick any 2 influences to put back. Not blockable. Can
            block <hl id="captain-color">STEAL</hl><br/><br/>

            <u id ="contessa-color">Contessa</u><br/>
            <hl id ="contessa-color">BLOCK ASSASSINATION</hl>: Can block <hl id = "assassin-color">assassinations</hl>. Not blockable.<br/><br/>
